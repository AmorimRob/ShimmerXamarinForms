...
[assembly: ExportRenderer(typeof(GradientViewRender), typeof(GradientTest.iOS.GradientViewRenderer))]
namespace GradientTest.iOS
{
    public class GradientViewRenderer : ViewRenderer<GradientViewRender, UIView>
    {
        UIView mainView;
        UIView gradientView;
